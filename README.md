...
*A robust mathematical utility designed to execute both basic arithmetic operations and complex expressions with precise decimal handling.*
- **Tech Stack:** Java (Swing/AWT) / JavaScript, Object-Oriented Programming (OOPs), Event-Driven Architecture, HTML/CSS
- **Key Features:**
  - **Expression Parsing & Logic:** Engineered algorithmic backend logic to process sequential operations, manage operator precedence, and parse multi-digit numbers seamlessly.
